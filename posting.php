...
<?php if($post['Created'] != $post['modified']): echo (' (編集済み)')?>
<?php endif; ?>
...
<a href="edit.php?id=<?php echo htmlspecialchars($post['message_id'], ENT_QUOTES); ?>">編集</a>|</span>


<!-- 削除 -->
<a href="delete.php?id=<?php echo htmlspecialchars($post['message_id'], ENT_QUOTES); ?>">削除</a>]<?php endif; ?></span>
</p>
